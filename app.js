function calculateScore() {
  const answers = {
    ...
    q2: "a",  // คำตอบที่ถูกต้องสำหรับคำถาม 2
    q3: "a",  // คำตอบที่ถูกต้องสำหรับคำถาม 3
    q4: "a",  // คำตอบที่ถูกต้องสำหรับคำถาม 4
    q5: "a",  // คำตอบที่ถูกต้องสำหรับคำถาม 5
    q6: "a",  // คำตอบที่ถูกต้องสำหรับคำถาม 6
    q7: "a",  // คำตอบที่ถูกต้องสำหรับคำถาม 7
    q8: "a",  // คำตอบที่ถูกต้องสำหรับคำถาม 8
    q9: "a",  // คำตอบที่ถูกต้องสำหรับคำถาม 9
